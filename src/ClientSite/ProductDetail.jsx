...
function ProductDetail() {
  ...
  const addToCart = () => {
    ...
    if (itemIndex > -1) {
      ...
      alert(`${foundProduct.name} has been added to your cart with a quantity of ${quantity}.`);
